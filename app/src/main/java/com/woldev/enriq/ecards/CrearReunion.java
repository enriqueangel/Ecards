...
public class CrearReunion extends AppCompatActivity {
        ...
        CrearReunion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if  (!MetodosGlobales.validarCampoVacio(Fecha.getText().toString())){
                    ...
                    //Toast.makeText(com.woldev.enriq.ecards.CrearReunion.this, "Ingrese un lugar" , Toast.LENGTH_SHORT).show();
                    return;
                }else{
    ...
    private void EnviarDatosWS(){
        ...
        if ( ListaUsuarios == null || !(ListaUsuarios.size() > 0) ){
            Toast.makeText(com.woldev.enriq.ecards.CrearReunion.this, "Debe seleccionar minimo un usuario" , Toast.LENGTH_SHORT).show();
            return;
        }
