...
public class ActivityCrearReunion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CrearReunion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if  (!MetodosGlobales.validarCampoVacio(Titulo.getText().toString())){
                    ...
                    //Toast.makeText(com.woldev.enriq.ecards.ActivityCrearReunion.this, "Ingrese un Titulo", Toast.LENGTH_SHORT).show();
                    return;
                }else{
                ...
                if  (!MetodosGlobales.validarCampoVacio(Fecha.getText().toString())){
                    ...
                    //Toast.makeText(com.woldev.enriq.ecards.ActivityCrearReunion.this, "Ingrese un lugar" , Toast.LENGTH_SHORT).show();
                    return;
                }else{
        ...
        Fecha.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(ActivityCrearReunion.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        Hora.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(ActivityCrearReunion.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            case android.R.id.home:
                //Intent i = new Intent(ActivityCrearReunion.this, ActivityMenuAdmin.class);
                //startActivity(i);
                finish();
                return true;
            default:
    ...
    private void EnviarDatosWS(){
        ...
        if ( ListaUsuarios == null || !(ListaUsuarios.size() > 0) ){
            Toast.makeText(ActivityCrearReunion.this, "Debe seleccionar minimo un usuario" , Toast.LENGTH_SHORT).show();
            return;
        }
