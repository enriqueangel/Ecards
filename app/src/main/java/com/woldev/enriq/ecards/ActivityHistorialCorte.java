...
public class ActivityHistorialCorte extends AppCompatActivity {
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            dialog.dismiss();
                            Toast.makeText(ActivityHistorialCorte.this, "Error cargando los cortes.", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
