...
public class ActivityRecuperarPin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BTRecuperarPIN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                boolean confirmContrasena = validarContrasena(Contra);
                                ...
                                public void onResponse(JSONObject response) {
                                    try {
                                        ...
                                        if(respuesta.equals("si")){
                                            dialog.dismiss();
                                            Intent intent = new Intent(ActivityRecuperarPin.this, ActivityCrearPin.class);
    ...
    public boolean validarContrasena(EditText contasena){
