...
public class AdapterExpandableListRadio extends BaseExpandableListAdapter {
    ...
    AdapterExpandableListRadio(Context context, List<String> listDataHeader, HashMap<String, List<ItemListCheckbox>> listHashMap) {
