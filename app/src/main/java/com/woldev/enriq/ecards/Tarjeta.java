...
* en la vista, las voy a utilizar en el AdapterTarjetas y de esta manera conectar lo que me llegue a ellas desde la base
...
public class Tarjeta {
    ...
    public Tarjeta(String titulo, String tipo, String tiempo_e, String tiempo_r, String version, int color, boolean isReunion, JSONObject DATOS, Boolean Activa) {
        this.titulo = titulo;
        this.tipo = tipo;
